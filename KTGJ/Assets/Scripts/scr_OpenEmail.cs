...
public class scr_OpenEmail : MonoBehaviour
{
    ...
    public void setEmailContents(int in_eventID, string in_sender, string in_subject, string in_recieved, string in_message, int in_funds, int in_mood, int in_fontSize = 34)
    {
        eventID = in_eventID;
        textContainers[0].text = in_sender;
        textContainers[1].text = in_subject;
        ...
        textContainers[3].text = in_message;
        textContainers[3].fontSize = in_fontSize;
        textContainers[4].text = " + $" + in_funds + " .M";
        textContainers[5].text = " - " + in_mood + " Mood";
    }
}
